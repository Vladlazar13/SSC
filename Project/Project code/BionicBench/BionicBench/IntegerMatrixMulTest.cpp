...
IntegerMatrixMulTest::IntegerMatrixMulTest(QTextEdit *textEdit, QProgressBar *progressBar)
{
	this->min_dim = 100;
	this->max_dim = 500;
	this->step = 100;
...
IntegerMatrixMulTest::IntegerMatrixMulTest(QTextEdit *textEdit, QProgressBar *progressBar,int min_dim, int max_dim, int step, int nr_tests_per_run)
{
...
void IntegerMatrixMulTest::runTest() {
	this->textEdit->append("Integer Matrix Mul Test \n \n ");
